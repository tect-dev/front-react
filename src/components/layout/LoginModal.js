  ...
  return (
    <Cotainer>
      ...
      <p>
        ...
        서비스 및 기능을 말합니다. 📌 “이용자“란, 이 약관에 따라 서비스를
        이용하는 회원 및 비회원을 말합니다. 📌 “회원“이란, 서비스에 회원등록을
        하고 서비스를 이용하는 자를 말합니다. 📌 “비회원“이란, 서비스에
        회원등록을 하지 않고 서비스를 이용하는 자를 말합니다. 📌 “게시물“이란,
        서비스에 게재된 문자, 사진, 영상, 첨부파일 등을 말합니다. 📌
        “커뮤니티“란, 회사와 이용자가 게시물을 게시할 수 있는 공간을 말합니다.
        📌 “이용 기록“이란, 이용자가 서비스를 이용하면서 직접 생성/참여한
        게시글, 댓글 등을 말합니다. 📌 “로그 기록“이란, 이용자가 서비스를
        이용하면서 자동으로 생성된 IP 주소, 접속 시간 등을 말합니다. 📌 “기기
        정보“란, 이용자의 통신 기기에서 수집된 운영체제 종류, ADID 등을
        말합니다. 📌 “계정“이란, 이용계약을 통해 생성된 회원의 고유 아이디와
        이에 수반하는 정보를 말합니다. 📌 “연락처“란, 회원가입, 본인 인증, 문의
        창구 등을 통해 수집된 이용자의 이메일, 휴대전화 번호 등을 의미합니다. 📌
        “관련법“이란, 정보통신망 이용촉진 및 정보보호 등에 관한 법률,
        개인정보보호법, 통신비밀보호법 등 관련 있는 국내외 법령을 말합니다. 📌
      ...
      <h5>제4조(서비스의 제공)</h5>
      <p>
        1. 회사는 다음 서비스를 제공합니다. 📌 문서 작성 서비스 📌 커뮤니티
        서비스 📌 할인, 이벤트, 프로모션, 광고 정보 제공 서비스 📌 기타 회사가
        정하는 서비스
      </p>
      <p>
      ...
      <p style={{ marginBottom: '10px' }}>
        ...
        무결성, 신뢰성, 이용가능성 📌 서비스 이용 중 타인과 상호 간에 합의한
        내용 📌 게시물, 광고의 버튼, 하이퍼링크 등 외부로 연결된 서비스와 같이
        회사가 제공하지 않은 서비스에서 발생한 피해 📌 이용자의 귀책사유 또는
        회사의 귀책 사유가 아닌 사유로 발생한 이용자의 피해
      </p>
      ...
      <h5>제12조(금지행위)</h5>
      <p>
        1. 이용자는 다음과 같은 행위를 해서는 안됩니다. 📌 개인정보 또는 계정
        기만, 침해, 공유 행위 📌 개인정보를 허위, 누락, 오기, 도용하여 작성하는
        행위 📌 타인의 개인정보 및 계정을 수집, 저장, 공개, 이용하는 행위 📌
        자신과 타인의 개인정보를 제3자에게 공개, 양도하는 행위 📌 다중 계정을
        생성 및 이용하는 행위 📌 자신의 계정을 이용하여 타인의 요청을 이행하는
        행위 📌 시스템 부정행위 📌 허가하지 않은 방식의 서비스 이용 행위 📌
        회사의 모든 재산에 대한 침해 행위 📌 업무 방해 행위 📌 서비스 관리자
        또는 이에 준하는 자격을 사칭하거나 허가없이 취득하여 직권을 행사하는
        행위 📌 회사 및 타인의 명예를 손상시키거나 업무를 방해하는 행위 📌
        서비스 내부 정보 일체를 허가 없이 이용, 변조, 삭제 및 외부로 유출하는
        행위 📌 이 약관, 개인정보 처리방침, 커뮤니티 이용규칙에서 이행 및
        비이행을 명시한 내용에 반하는 행위 📌 기타 현행법에 어긋나거나
        부적절하다고 판단되는 행위
      </p>
      <p>
        2. 이용자가 1항에 해당하는 행위를 할 경우, 회사는 다음과 같은 조치를
        영구적으로 취할 수 있습니다. 📌 이용자의 서비스 이용 권한, 자격, 혜택
        제한 및 회수 📌 회원과 체결된 이용계약을 회원의 동의나 통보 없이 파기 📌
        회원가입, 본인 인증, 학교 인증 거부 📌 회원의 커뮤니티, 게시물,
        이용기록을 임의로 삭제, 중단, 변경 📌 그 외 회사가 필요하다고 판단되는
        조치
      </p>
      <p style={{ marginBottom: '10px' }}>
