...
import { colorPalette, boxShadow, hoverAction, fontSize } from '../../lib/constants'
      ...
      <TwoOneMainWapper>
        <BoardListWrapper>
          <BoardListHeader>
            ...
            <Buttons>
              <Button2> <span>인기순</span> </Button2>
              <Button2> <span>최신순</span> </Button2>
              <Button>
                {loginState ? (
            ...
            return (
              <Link to={`/post/${postData._id}`} key={idx}>
                <PostCard>
                  ...
                  <LikeComment>
                    <div style={{marginRight: "10px"}}>좋아요 {postData.like}</div>
