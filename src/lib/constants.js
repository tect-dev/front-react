      ...
      <g id="그룹_14" data-name="그룹 14" transform="translate(-365 -717)">
        ...
        <g id="그룹_3" data-name="그룹 3" transform="translate(-8.137 450.947)">
          <circle
            ...
            cy="7.298"
            r="7.298"
            transform="translate(385.846 276)"
            fill="#fff"
          />
          <path
            id="패스_1"
            data-name="패스 1"
            d="M393.137,414a12.151,12.151,0,0,0-12.151,12.136h24.3A12.151,12.151,0,0,0,393.137,414Z"
            transform="translate(0 -121.083)"
            fill="#fff"
          />
        </g>
      </g>
